...
void midifex_effect_4(int16_t input, int16_t *out_left, int16_t *out_right, int16_t DRAM[0x4000], int ptr) {
	int16_t Acc, tmp_1cd0, tmp_1, tmp_2;
	WRITE_LINE(0, 0) = input;
...
void midifex_effect_5(int16_t input, int16_t *out_left, int16_t *out_right, int16_t DRAM[0x4000], int ptr) {
	...
	tmp_1 = Acc;
	Acc = Acc * -3 / 16 + LINE(2, 7303, 1) / 8 + tmp_1;
	WRITE_LINE(1, 7300) = Acc;
	Acc = LINE(1, 7300, 1);
	tmp_1 = -Acc;
	Acc = LINE(2, 7303, 1) * 3 / 2 + tmp_1 * 3 / 2;
...
void midifex_effect_10(int16_t input, int16_t *out_left, int16_t *out_right, int16_t DRAM[0x4000], int ptr) {
	...
	tmp_1 = Acc;
	Acc = Acc * -3 / 16 + LINE(2, 10102, 1) / 8 + tmp_1;
...
void midifex_effect_17(int16_t input, int16_t *out_left, int16_t *out_right, int16_t DRAM[0x4000], int ptr) {
	...
	tmp_1 = Acc;
	Acc = Acc * -3 / 16 + LINE(2, 12681, 1) / 8 + tmp_1;
	WRITE_LINE(1, 12678) = Acc;
	Acc = LINE(1, 12678, 1);
	tmp_1 = -Acc;
	Acc = LINE(2, 12681, 1) * 3 / 2 + tmp_1 * 3 / 2;
	WRITE_LINE(9, 16381) = Acc;
	*out_left = tmp_5;
	*out_right = tmp_3;
}
...
void midifex_effect_21(int16_t input, int16_t *out_left, int16_t *out_right, int16_t DRAM[0x4000], int ptr) {
	...
	tmp_1 = -Acc;
	*out_left = tmp_5;
	Acc = LINE(4, 13612, 1) * 3 / 2 + tmp_1 * 3 / 2;
...
void midifex_effect_23(int16_t input, int16_t *out_left, int16_t *out_right, int16_t DRAM[0x4000], int ptr) {
	...
	Acc = LINE(3, 3539, 1);
	tmp_1 = -Acc;
	Acc = LINE(0, 0, 1) * 3 / 2 + tmp_1 * 3 / 2;
	WRITE_LINE(11, 16381) = Acc;
	Acc = LINE(2, 3536, 1) * 13 / 16;
	tmp_1 = Acc;
	Acc = LINE(11, 16381, 6093) * 3 / 16 + tmp_1;
	WRITE_LINE(2, 3536) = Acc;
	Acc = LINE(2, 3536, 1);
	tmp_1 = -Acc;
	Acc = LINE(11, 16381, 6093) * 3 / 2 + tmp_1 * 3 / 2;
	WRITE_LINE(10, 10286) = Acc;
	Acc = LINE(1, 3533, 1) / 4;
	tmp_1 = Acc;
	*out_left = tmp_5;
	Acc = LINE(1, 3533, 7) * 3 / 4 + tmp_1;
...
void midifex_effect_24(int16_t input, int16_t *out_left, int16_t *out_right, int16_t DRAM[0x4000], int ptr) {
	...
	tmp_1 = Acc;
	Acc = Acc * -3 / 16 + LINE(4, 4945, 1) / 8 + tmp_1;
	...
	tmp_1 = Acc;
	Acc = Acc * -3 / 16 + LINE(2, 4939, 1) / 8 + tmp_1;
	WRITE_LINE(1, 4936) = Acc;
	Acc = LINE(1, 4936, 1);
	tmp_1 = -Acc;
	Acc = LINE(2, 4939, 1) * 3 / 2 + tmp_1 * 3 / 2;
...
void midifex_effect_28(int16_t input, int16_t *out_left, int16_t *out_right, int16_t DRAM[0x4000], int ptr) {
	...
	Acc = LINE(2, 9652, 1);
	tmp_1 = -Acc;
	Acc = LINE(3, 9655, 1) * 3 / 2 + tmp_1 * 3 / 2;
...
void midifex_effect_34(int16_t input, int16_t *out_left, int16_t *out_right, int16_t DRAM[0x4000], int ptr) {
	...
	Acc = LINE(3, 5886, 1);
	tmp_1 = -Acc;
	Acc = LINE(4, 5889, 1) * 9 / 4 + tmp_1 * 9 / 4;
	...
	*out_left = tmp_5;
	...
	tmp_1 = -Acc;
	*out_right = tmp_3;
	Acc = LINE(2, 5883, 1) * 9 / 4 + tmp_1 * 9 / 4;
...
void midifex_effect_35(int16_t input, int16_t *out_left, int16_t *out_right, int16_t DRAM[0x4000], int ptr) {
	...
	tmp_1 = Acc;
	Acc = Acc * -3 / 16 + LINE(12, 16381, 2808) / 8 + tmp_1;
	...
	*out_left = tmp_5;
	...
	tmp_1 = Acc;
	Acc = LINE(11, 13571, 2808) * 3 / 16 + tmp_1;
	WRITE_LINE(1, 7293) = Acc;
	Acc = LINE(1, 7293, 1);
	tmp_1 = -Acc;
	*out_right = tmp_3;
	Acc = LINE(11, 13571, 2808) * 3 / 2 + tmp_1 * 3 / 2;
...
void midifex_effect_39(int16_t input, int16_t *out_left, int16_t *out_right, int16_t DRAM[0x4000], int ptr) {
	int16_t Acc, tmp_0, tmp_1, tmp_2, tmp_3, tmp_5;
