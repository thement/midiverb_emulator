...
void midiverb2_f_effect_0(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_1(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(18, 15972, 12) * 0.75 + LINE(17, 15549, 234) * 0.75 + LINE(16, 15035, 252) * 0.75 + LINE(15, 14477, 378) * 0.75 + LINE(10, 12812, 169) * 0.75 + LINE(9, 12375, 199) * 0.75 + LINE(8, 11892, 423) * 0.75;
	tmp_3 = Acc;
	Acc = LINE(18, 15972, 145) * 0.75 + LINE(17, 15549, 130) * 0.75 + LINE(16, 15035, 459) * 0.75 + LINE(15, 14477, 277) * 0.75 + LINE(10, 12812, 103) * 0.75 + LINE(9, 12375, 208) * 0.75 + LINE(6, 10744, 16) * 0.75;
	tmp_5 = Acc;
	Acc = LINE(23, 16381, 19) * 0.75 + LINE(0, 0, 1) / 2;
	WRITE_LINE(23, 16381) = -Acc;
	Acc = Acc * -0.75 + LINE(22, 16360, 45) * 0.75 + LINE(23, 16381, 19);
	WRITE_LINE(22, 16360) = -Acc;
	Acc = Acc * -0.75 + LINE(21, 16313, 84) * 0.75 + LINE(22, 16360, 45);
	WRITE_LINE(21, 16313) = -Acc;
	Acc = Acc * -0.75 + LINE(20, 16227, 115) * 0.75 + LINE(21, 16313, 84);
	WRITE_LINE(20, 16227) = -Acc;
	Acc = Acc * -0.75 + LINE(19, 16110, 136) * 0.75 + LINE(20, 16227, 115);
	WRITE_LINE(19, 16110) = -Acc;
	Acc = Acc * -1.125 + LINE(19, 16110, 136) * 1.5;
	tmp_b = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_2(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(20, 15962, 120) * 0.75 + LINE(19, 15092, 334) * 0.75 + LINE(16, 12751, 252) * 0.75 + LINE(15, 11359, 478) * 0.75 + LINE(12, 9457, 369) * 0.75 + LINE(11, 8482, 499) * 0.75 + LINE(8, 6402, 723) * 0.75 + LINE(7, 5629, 214) * 0.75;
	tmp_3 = Acc;
	Acc = LINE(20, 15962, 129) * 0.75 + LINE(19, 15092, 130) * 0.75 + LINE(16, 12751, 459) * 0.75 + LINE(15, 11359, 277) * 0.75 + LINE(12, 9457, 363) * 0.75 + LINE(11, 8482, 208) * 0.75 + LINE(8, 6402, 421) * 0.75 + LINE(7, 5629, 891) * 0.75;
	tmp_5 = Acc;
	Acc = LINE(25, 16381, 19) * 0.75 + LINE(0, 0, 1) / 2;
	WRITE_LINE(25, 16381) = -Acc;
	Acc = Acc * -0.75 + LINE(24, 16360, 45) * 0.75 + LINE(25, 16381, 19);
	WRITE_LINE(24, 16360) = -Acc;
	Acc = Acc * -0.75 + LINE(23, 16313, 84) * 0.75 + LINE(24, 16360, 45);
	WRITE_LINE(23, 16313) = -Acc;
	Acc = Acc * -0.75 + LINE(22, 16227, 115) * 0.75 + LINE(23, 16313, 84);
	WRITE_LINE(22, 16227) = -Acc;
	Acc = Acc * -0.75 + LINE(21, 16110, 146) * 0.75 + LINE(22, 16227, 115);
	WRITE_LINE(21, 16110) = -Acc;
	Acc = Acc * -1.125 + LINE(21, 16110, 146) * 1.5;
	tmp_b = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_3(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(20, 15962, 320) * 0.75 + LINE(19, 15092, 734) * 0.75 + LINE(16, 12551, 252) * 0.75 + LINE(15, 11159, 478) * 0.75 + LINE(12, 8857, 369) * 0.75 + LINE(11, 7621, 499) * 0.75 + LINE(8, 5441, 723) * 0.75 + LINE(7, 4468, 214) * 0.75;
	tmp_3 = Acc;
	Acc = LINE(20, 15962, 129) * 0.75 + LINE(19, 15092, 130) * 0.75 + LINE(16, 12551, 859) * 0.75 + LINE(15, 11159, 277) * 0.75 + LINE(12, 8857, 563) * 0.75 + LINE(11, 7621, 208) * 0.75 + LINE(8, 5441, 421) * 0.75 + LINE(7, 4468, 891) * 0.75;
	tmp_5 = Acc;
	Acc = LINE(25, 16381, 19) * 0.75 + LINE(0, 0, 1) / 2;
	WRITE_LINE(25, 16381) = -Acc;
	Acc = Acc * -0.75 + LINE(24, 16360, 45) * 0.75 + LINE(25, 16381, 19);
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_4(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(8, 14885, 361) * 1.125 + LINE(6, 11865, 789) * 1.125 + LINE(4, 7880, 1703) * 1.125;
	tmp_3 = Acc;
	Acc = LINE(8, 14885, 576) * 1.125 + LINE(6, 11865, 390) * 1.125 + LINE(4, 7880, 671) * 1.125;
	tmp_5 = Acc;
	...
	Acc = Acc * -0.75 + LINE(9, 15485, 598) * 1.5;
	tmp_b = Acc;
	...
	Acc = LINE(4, 7880, 2657) * 0.75 + LINE(3, 5221, 1612) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_5(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(19, 15952, 120) * 1.125 + LINE(18, 15282, 334) * 1.125 + LINE(17, 14568, 252) * 1.125 + LINE(16, 13710, 478) * 1.125 + LINE(11, 11245, 369) * 1.125 + LINE(10, 10670, 499) * 1.125 + LINE(9, 9987, 723) * 1.125 + LINE(8, 9114, 207) * 1.125;
	tmp_3 = Acc;
	Acc = LINE(19, 15952, 129) * 1.125 + LINE(18, 15282, 130) * 1.125 + LINE(17, 14568, 459) * 1.125 + LINE(16, 13710, 277) * 1.125 + LINE(11, 11245, 363) * 1.125 + LINE(10, 10670, 208) * 1.125 + LINE(9, 9987, 451) * 1.125 + LINE(7, 8279, 56) * 1.125;
	tmp_5 = Acc;
	Acc = LINE(3, 6812, 1) / 2 + LINE(0, 0, 1) / 2;
	WRITE_LINE(3, 6812) = Acc;
	Acc = LINE(24, 16381, 19) * 0.75 + LINE(0, 0, 1) / 2;
	WRITE_LINE(24, 16381) = -Acc;
	Acc = Acc * -0.75 + LINE(23, 16360, 45) * 0.75 + LINE(24, 16381, 19);
	WRITE_LINE(23, 16360) = -Acc;
	Acc = Acc * -0.75 + LINE(22, 16313, 84) * 0.75 + LINE(23, 16360, 45);
	WRITE_LINE(22, 16313) = -Acc;
	Acc = Acc * -0.75 + LINE(21, 16227, 115) * 0.75 + LINE(22, 16313, 84);
	WRITE_LINE(21, 16227) = -Acc;
	Acc = Acc * -0.75 + LINE(20, 16110, 156) * 0.75 + LINE(21, 16227, 115);
	WRITE_LINE(20, 16110) = -Acc;
	Acc = Acc * -0.75 + LINE(20, 16110, 156);
	tmp_b = Acc;
	Acc = LINE(19, 15952, 668) * 0.75 + LINE(15, 12830, 478) / 2;
	WRITE_LINE(15, 12830) = -Acc;
	Acc = -Acc / 2 + LINE(15, 12830, 478);
	WRITE_LINE(18, 15282) = Acc;
	Acc = LINE(18, 15282, 712) * 0.75 + LINE(14, 12350, 312) / 2;
	WRITE_LINE(14, 12350) = -Acc;
	Acc = -Acc / 2 + LINE(14, 12350, 312);
	WRITE_LINE(17, 14568) = Acc;
	Acc = LINE(17, 14568, 856) * 0.75 + LINE(13, 12036, 456) / 2;
	WRITE_LINE(13, 12036) = -Acc;
	Acc = -Acc / 2 + LINE(13, 12036, 456);
	WRITE_LINE(16, 13710) = Acc;
	Acc = LINE(16, 13710, 878) * 0.75 + LINE(12, 11578, 331) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_6(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(10, 14666, 345) * 1.125 + LINE(8, 10834, 987) * 1.125 + LINE(4, 3735, 678) * 1.125 + LINE(6, 7372, 345) * 1.125;
	tmp_3 = Acc;
	Acc = LINE(10, 14666, 685) * 1.125 + LINE(8, 10834, 342) * 1.125 + LINE(4, 3735, 340) * 1.125 + LINE(6, 7372, 1023) * 1.125;
	tmp_5 = Acc;
	Acc = LINE(15, 16282, 98) * 0.625 + LINE(0, 0, 100) / 2;
	WRITE_LINE(15, 16282) = -Acc;
	Acc = -Acc / 8 + LINE(14, 16182, 198) * 0.625 + LINE(15, 16282, 0) / 2 + LINE(15, 16282, 98);
	WRITE_LINE(14, 16182) = -Acc;
	Acc = -Acc / 8 + LINE(13, 15982, 367) * 0.625 + LINE(14, 16182, 0) / 2 + LINE(14, 16182, 198);
	WRITE_LINE(13, 15982) = -Acc;
	Acc = -Acc / 8 + LINE(12, 15613, 598) * 0.625 + LINE(13, 15982, 0) / 2 + LINE(13, 15982, 367);
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_7(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(11, 14666, 1209) * 1.125 + LINE(9, 10834, 987) * 1.125 + LINE(5, 3735, 678) * 1.125 + LINE(7, 7372, 787) * 1.125;
	tmp_3 = Acc;
	Acc = LINE(11, 14666, 685) * 1.125 + LINE(9, 10834, 342) * 1.125 + LINE(5, 3735, 340) * 1.125 + LINE(7, 7372, 1023) * 1.125;
	tmp_5 = Acc;
	Acc = LINE(0, 0, 100) / 2 + LINE(3, 163, 1) / 2;
	WRITE_LINE(3, 163) = Acc;
	Acc = LINE(16, 16282, 98) * 0.625 + LINE(3, 163, 1) / 2;
	WRITE_LINE(16, 16282) = -Acc;
	Acc = -Acc / 8 + LINE(15, 16182, 198) * 0.625 + LINE(16, 16282, 0) / 2 + LINE(16, 16282, 98);
	WRITE_LINE(15, 16182) = -Acc;
	Acc = -Acc / 8 + LINE(14, 15982, 367) * 0.625 + LINE(15, 16182, 0) / 2 + LINE(15, 16182, 198);
	WRITE_LINE(14, 15982) = -Acc;
	Acc = -Acc / 8 + LINE(13, 15613, 598) * 0.625 + LINE(14, 15982, 0) / 2 + LINE(14, 15982, 367);
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_8(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(19, 15952, 120) * 1.125 + LINE(18, 15282, 334) * 1.125 + LINE(17, 14568, 252) * 1.125 + LINE(16, 13710, 478) * 1.125 + LINE(11, 11245, 369) * 1.125 + LINE(10, 10670, 499) * 1.125 + LINE(9, 9987, 723) * 1.125 + LINE(8, 9114, 207) * 1.125;
	tmp_3 = Acc;
	...
	Acc = LINE(3, 6812, 1) / 2 + LINE(0, 0, 1) / 2;
	WRITE_LINE(3, 6812) = Acc;
	Acc = LINE(24, 16381, 19) * 0.75 + LINE(3, 6812, 0) / 2;
	WRITE_LINE(24, 16381) = -Acc;
	Acc = Acc * -0.75 + LINE(23, 16360, 45) * 0.75 + LINE(24, 16381, 19);
	WRITE_LINE(23, 16360) = -Acc;
	Acc = Acc * -0.75 + LINE(22, 16313, 84) * 0.75 + LINE(23, 16360, 45);
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_9(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(17, 15922, 120) * 1.125 + LINE(16, 14952, 334) * 1.125 + LINE(15, 14138, 252) * 1.125 + LINE(14, 13180, 478) * 1.125 + LINE(9, 9647, 369) * 1.125 + LINE(8, 8772, 499) * 1.125 + LINE(7, 7889, 323) * 1.125;
	tmp_3 = -Acc;
	Acc = LINE(17, 15922, 129) * 1.125 + LINE(16, 14952, 130) * 1.125 + LINE(15, 14138, 459) * 1.125 + LINE(14, 13180, 277) * 1.125 + LINE(9, 9647, 363) * 1.125 + LINE(8, 8772, 208) * 1.125 + LINE(6, 6916, 491) * 1.125;
	tmp_5 = -Acc;
	Acc = LINE(0, 0, 1) / 2 + LINE(1, 3037, 1) / 2;
	WRITE_LINE(1, 3037) = Acc;
	Acc = LINE(22, 16381, 19) * 0.75 + LINE(1, 3037, 0) / 2;
	WRITE_LINE(22, 16381) = -Acc;
	Acc = Acc * -0.75 + LINE(21, 16360, 45) * 0.75 + LINE(22, 16381, 19);
	WRITE_LINE(21, 16360) = -Acc;
	Acc = Acc * -0.75 + LINE(20, 16313, 84) * 0.75 + LINE(21, 16360, 45);
	WRITE_LINE(20, 16313) = -Acc;
	Acc = Acc * -0.75 + LINE(19, 16227, 125) * 0.75 + LINE(20, 16313, 84);
	WRITE_LINE(19, 16227) = -Acc;
	Acc = Acc * -0.75 + LINE(18, 16100, 176) * 0.75 + LINE(19, 16227, 125);
	WRITE_LINE(18, 16100) = -Acc;
	Acc = Acc * -0.75 + LINE(18, 16100, 176);
	tmp_b = -Acc;
	Acc = LINE(17, 15922, 968) * 0.625 + LINE(13, 12432, 678) / 2;
	...
	*out_left = tmp_5;
	...
	Acc = LINE(7, 7889, 971) * 0.625 + LINE(3, 4607, 634) / 2;
	WRITE_LINE(3, 4607) = -Acc;
	Acc = -Acc / 2 + LINE(3, 4607, 634);
	WRITE_LINE(6, 6916) = Acc;
	*out_right = tmp_3;
	Acc = LINE(6, 6916, 1010) * 0.625 + LINE(2, 3971, 932) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_10(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(16, 15922, 120) * 1.125 + LINE(15, 14952, 334) * 1.125 + LINE(14, 14138, 252) * 1.125 + LINE(13, 13180, 478) * 1.125 + LINE(8, 9647, 369) * 1.125 + LINE(7, 8772, 499) * 1.125 + LINE(6, 7889, 323) * 1.125;
	tmp_3 = Acc;
	Acc = LINE(16, 15922, 129) * 1.125 + LINE(15, 14952, 130) * 1.125 + LINE(14, 14138, 459) * 1.125 + LINE(13, 13180, 277) * 1.125 + LINE(8, 9647, 363) * 1.125 + LINE(7, 8772, 208) * 1.125 + LINE(5, 6916, 491) * 1.125;
	tmp_5 = Acc;
	Acc = LINE(21, 16381, 19) * 0.75 + LINE(0, 0, 1) / 2;
	WRITE_LINE(21, 16381) = -Acc;
	Acc = Acc * -0.75 + LINE(20, 16360, 45) * 0.75 + LINE(21, 16381, 19);
	WRITE_LINE(20, 16360) = -Acc;
	Acc = Acc * -0.75 + LINE(19, 16313, 84) * 0.75 + LINE(20, 16360, 45);
	WRITE_LINE(19, 16313) = -Acc;
	Acc = Acc * -0.75 + LINE(18, 16227, 125) * 0.75 + LINE(19, 16313, 84);
	WRITE_LINE(18, 16227) = -Acc;
	Acc = Acc * -0.75 + LINE(17, 16100, 176) * 0.75 + LINE(18, 16227, 125);
	WRITE_LINE(17, 16100) = -Acc;
	Acc = Acc * -0.75 + LINE(17, 16100, 176);
	tmp_b = Acc;
	Acc = LINE(16, 15922, 968) * 0.625 + LINE(12, 12432, 678) / 2;
	WRITE_LINE(12, 12432) = -Acc;
	Acc = -Acc / 2 + LINE(12, 12432, 678);
	WRITE_LINE(15, 14952) = Acc;
	Acc = LINE(15, 14952, 812) * 0.625 + LINE(11, 11752, 512) / 2;
	WRITE_LINE(11, 11752) = -Acc;
	Acc = -Acc / 2 + LINE(11, 11752, 512);
	WRITE_LINE(14, 14138) = Acc;
	Acc = LINE(14, 14138, 956) * 0.625 + LINE(10, 11238, 756) / 2;
	WRITE_LINE(10, 11238) = -Acc;
	Acc = -Acc / 2 + LINE(10, 11238, 756);
	WRITE_LINE(13, 13180) = Acc;
	Acc = LINE(13, 13180, 746) * 0.625 + LINE(9, 10480, 831) / 2;
	WRITE_LINE(9, 10480) = -Acc;
	Acc = -Acc / 2 + LINE(9, 10480, 831) + tmp_b;
	WRITE_LINE(16, 15922) = Acc;
	Acc = LINE(8, 9647, 873) * 0.625 + LINE(4, 5904, 512) / 2;
	WRITE_LINE(4, 5904) = -Acc;
	Acc = -Acc / 2 + LINE(4, 5904, 512);
	WRITE_LINE(7, 8772) = Acc;
	*out_left = tmp_5;
	Acc = LINE(7, 8772, 881) * 0.625 + LINE(3, 5390, 781) / 2;
	WRITE_LINE(3, 5390) = -Acc;
	Acc = -Acc / 2 + LINE(3, 5390, 781);
	WRITE_LINE(6, 7889) = Acc;
	Acc = LINE(6, 7889, 971) * 0.625 + LINE(2, 4607, 634) / 2;
	WRITE_LINE(2, 4607) = -Acc;
	*out_right = tmp_3;
	Acc = -Acc / 2 + LINE(2, 4607, 634);
	WRITE_LINE(5, 6916) = Acc;
	Acc = LINE(5, 6916, 1010) * 0.625 + LINE(1, 3971, 932) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_11(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(18, 15922, 120) * 1.125 + LINE(17, 14952, 334) * 1.125 + LINE(16, 14138, 252) * 1.125 + LINE(15, 13180, 478) * 1.125 + LINE(10, 9647, 369) * 1.125 + LINE(9, 8772, 499) * 1.125 + LINE(8, 7889, 323) * 1.125;
	tmp_3 = Acc;
	Acc = LINE(18, 15922, 129) * 1.125 + LINE(17, 14952, 130) * 1.125 + LINE(16, 14138, 459) * 1.125 + LINE(15, 13180, 277) * 1.125 + LINE(10, 9647, 363) * 1.125 + LINE(9, 8772, 208) * 1.125 + LINE(7, 6916, 491) * 1.125;
	tmp_5 = Acc;
	Acc = LINE(23, 16381, 19) * 0.75 + LINE(0, 0, 1) / 2;
	WRITE_LINE(23, 16381) = -Acc;
	Acc = Acc * -0.75 + LINE(22, 16360, 45) * 0.75 + LINE(23, 16381, 19);
	...
	Acc = Acc * -0.75 + LINE(21, 16313, 84) * 0.75 + LINE(22, 16360, 45);
	WRITE_LINE(21, 16313) = -Acc;
	Acc = Acc * -0.75 + LINE(20, 16227, 125) * 0.75 + LINE(21, 16313, 84);
	WRITE_LINE(20, 16227) = -Acc;
	Acc = Acc * -0.75 + LINE(19, 16100, 176) * 0.75 + LINE(20, 16227, 125);
	WRITE_LINE(19, 16100) = -Acc;
	Acc = Acc * -0.75 + LINE(19, 16100, 176);
	tmp_b = Acc;
	Acc = LINE(18, 15922, 968) * 0.75 + LINE(14, 12432, 678) / 2;
	WRITE_LINE(14, 12432) = -Acc;
	Acc = -Acc / 2 + LINE(14, 12432, 678);
	WRITE_LINE(17, 14952) = Acc;
	Acc = LINE(17, 14952, 812) * 0.75 + LINE(13, 11752, 512) / 2;
	WRITE_LINE(13, 11752) = -Acc;
	Acc = -Acc / 2 + LINE(13, 11752, 512);
	WRITE_LINE(16, 14138) = Acc;
	Acc = LINE(16, 14138, 956) * 0.625 + LINE(12, 11238, 756) / 2;
	WRITE_LINE(12, 11238) = -Acc;
	Acc = -Acc / 2 + LINE(12, 11238, 756);
	WRITE_LINE(15, 13180) = Acc;
	Acc = LINE(15, 13180, 746) * 0.625 + LINE(11, 10480, 831) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_12(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(18, 15417, 37) * 0.75 + LINE(17, 14594, 336) * 0.75 + LINE(16, 13980, 454) * 0.75 + LINE(15, 13222, 478) * 0.75 + LINE(10, 9824, 569) * 0.75 + LINE(9, 8887, 499) * 0.75 + LINE(8, 7904, 723) * 0.75 + LINE(7, 7031, 391) * 0.75;
	tmp_3 = Acc;
	Acc = LINE(18, 15417, 370) * 0.75 + LINE(17, 14594, 230) * 0.75 + LINE(16, 13980, 457) * 0.75 + LINE(15, 13222, 477) * 0.75 + LINE(10, 9824, 569) * 0.75 + LINE(9, 8887, 208) * 0.75 + LINE(8, 7904, 223) * 0.75 + LINE(7, 7031, 891) * 0.75;
	tmp_5 = Acc;
	Acc = LINE(2, 3852, 1) / 2 + LINE(0, 0, 451) / 2;
	WRITE_LINE(2, 3852) = Acc;
	Acc = LINE(24, 15931, 7) * 0.75 + LINE(0, 0, 451) / 2;
	WRITE_LINE(24, 15931) = -Acc;
	Acc = Acc * -0.75 + LINE(23, 15922, 15) * 0.75 + LINE(24, 15931, 7);
	WRITE_LINE(23, 15922) = -Acc;
	Acc = Acc * -0.75 + LINE(22, 15905, 34) * 0.75 + LINE(23, 15922, 15);
	WRITE_LINE(22, 15905) = -Acc;
	Acc = Acc * -0.75 + LINE(21, 15869, 75) * 0.75 + LINE(22, 15905, 34);
	WRITE_LINE(21, 15869) = -Acc;
	Acc = Acc * -0.75 + LINE(20, 15792, 135) * 0.75 + LINE(21, 15869, 75);
	WRITE_LINE(20, 15792) = -Acc;
	Acc = Acc * -0.75 + LINE(19, 15655, 236) * 0.75 + LINE(20, 15792, 135);
	WRITE_LINE(19, 15655) = -Acc;
	Acc = Acc * -1.125 + LINE(19, 15655, 236) * 1.5;
	tmp_b = Acc;
	...
	Acc = LINE(16, 13980, 756) * -0.375 + LINE(16, 13980, 757) * -0.375 + LINE(12, 11037, 678) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_13(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(18, 15417, 37) * 0.75 + LINE(17, 14794, 236) * 0.75 + LINE(16, 14380, 454) * 0.75 + LINE(15, 13922, 478) * 0.75 + LINE(10, 10081, 569) * 0.75 + LINE(9, 9144, 499) * 0.75 + LINE(8, 8161, 723) * 0.75 + LINE(7, 7288, 391) * 0.75;
	tmp_3 = Acc;
	Acc = LINE(18, 15417, 37) * 0.75 + LINE(17, 14794, 230) * 0.75 + LINE(16, 14380, 457) * 0.75 + LINE(15, 13922, 477) * 0.75 + LINE(10, 10081, 569) * 0.75 + LINE(9, 9144, 508) * 0.75 + LINE(8, 8161, 223) * 0.75 + LINE(7, 7288, 891) * 0.75;
	tmp_5 = Acc;
	...
	Acc = LINE(16, 14380, 456) * -0.375 + LINE(16, 14380, 457) * -0.375 + LINE(12, 11637, 1021) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_14(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(17, 15922, 120) * 1.125 + LINE(16, 15252, 334) * 1.125 + LINE(15, 14438, 252) * 1.125 + LINE(14, 13480, 478) * 1.125 + LINE(9, 9683, 369) * 1.125 + LINE(8, 9008, 499) * 1.125 + LINE(7, 8125, 723) * 1.125;
	tmp_3 = Acc;
	Acc = LINE(17, 15922, 129) * 1.125 + LINE(16, 15252, 130) * 1.125 + LINE(15, 14438, 459) * 1.125 + LINE(14, 13480, 277) * 1.125 + LINE(9, 9683, 363) * 1.125 + LINE(8, 9008, 208) * 1.125 + LINE(6, 7152, 891) * 1.125;
	tmp_5 = Acc;
	Acc = LINE(1, 3073, 1) / 2 + LINE(0, 0, 1) / 2;
	WRITE_LINE(1, 3073) = Acc;
	Acc = LINE(22, 16381, 19) * 0.75 + LINE(1, 3073, 1) / 2;
	WRITE_LINE(22, 16381) = -Acc;
	Acc = Acc * -0.75 + LINE(21, 16360, 45) * 0.75 + LINE(22, 16381, 19);
	WRITE_LINE(21, 16360) = -Acc;
	Acc = Acc * -0.75 + LINE(20, 16313, 84) * 0.75 + LINE(21, 16360, 45);
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_15(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(19, 15922, 520) * 1.125 + LINE(18, 14952, 334) * 1.125 + LINE(17, 14138, 252) * 1.125 + LINE(16, 13180, 478) * 1.125 + LINE(11, 9183, 369) * 1.125 + LINE(10, 8408, 499) * 1.125 + LINE(9, 7525, 723) * 1.125;
	tmp_3 = Acc;
	Acc = LINE(19, 15922, 129) * 1.125 + LINE(18, 14952, 130) * 1.125 + LINE(17, 14138, 459) * 1.125 + LINE(16, 13180, 277) * 1.125 + LINE(11, 9183, 363) * 1.125 + LINE(10, 8408, 208) * 1.125 + LINE(8, 6552, 891) * 1.125;
	tmp_5 = Acc;
	...
	Acc = Acc * -0.75 + LINE(22, 16313, 84) * 0.75 + LINE(23, 16360, 45);
	WRITE_LINE(22, 16313) = -Acc;
	Acc = Acc * -0.75 + LINE(21, 16227, 125) * 0.75 + LINE(22, 16313, 84);
	WRITE_LINE(21, 16227) = -Acc;
	Acc = Acc * -0.75 + LINE(20, 16100, 176) * 0.75 + LINE(21, 16227, 125);
	WRITE_LINE(20, 16100) = -Acc;
	Acc = Acc * -0.75 + LINE(20, 16100, 176);
	tmp_b = Acc;
	Acc = LINE(19, 15922, 968) * 0.75 + LINE(15, 12068, 678) / 2;
	WRITE_LINE(15, 12068) = -Acc;
	Acc = -Acc / 2 + LINE(15, 12068, 678);
	WRITE_LINE(18, 14952) = Acc;
	Acc = LINE(18, 14952, 812) * 0.75 + LINE(14, 11388, 612) / 2;
	WRITE_LINE(14, 11388) = -Acc;
	Acc = -Acc / 2 + LINE(14, 11388, 612);
	WRITE_LINE(17, 14138) = Acc;
	Acc = LINE(17, 14138, 956) * 0.75 + LINE(13, 10774, 756) / 2;
	WRITE_LINE(13, 10774) = -Acc;
	Acc = -Acc / 2 + LINE(13, 10774, 756);
	WRITE_LINE(16, 13180) = Acc;
	Acc = LINE(16, 13180, 1110) * 0.75 + LINE(12, 10016, 831) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_16(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(17, 15922, 120) * 1.125 + LINE(16, 15252, 334) * 1.125 + LINE(15, 14438, 252) * 1.125 + LINE(14, 13480, 478) * 1.125 + LINE(9, 9683, 369) * 1.125 + LINE(8, 9008, 499) * 1.125 + LINE(7, 8125, 723) * 1.125;
	tmp_3 = Acc;
	...
	Acc = LINE(1, 3073, 1) / 2 + LINE(0, 0, 1) / 2;
	WRITE_LINE(1, 3073) = Acc;
	Acc = LINE(22, 16381, 19) * 0.75 + LINE(0, 0, 1) / 2;
	WRITE_LINE(22, 16381) = -Acc;
	Acc = Acc * -0.75 + LINE(21, 16360, 45) * 0.75 + LINE(22, 16381, 19);
	WRITE_LINE(21, 16360) = -Acc;
	Acc = Acc * -0.75 + LINE(20, 16313, 84) * 0.75 + LINE(21, 16360, 45);
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_17(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(8, 13337, 211) * 0.75 + LINE(6, 10417, 1391) * 0.75 + LINE(4, 6832, 1403) * 0.75;
	tmp_3 = Acc;
	Acc = LINE(8, 13337, 211) * 0.75 + LINE(6, 10417, 690) * 0.75 + LINE(4, 6832, 471) * 0.75;
	tmp_5 = Acc;
	...
	Acc = Acc * -1.125 + LINE(9, 13483, 144) * 2.25;
	tmp_b = Acc;
	Acc = LINE(8, 13337, 1724) * 0.75 + LINE(7, 11611, 1192) / 2;
	WRITE_LINE(7, 11611) = -Acc;
	Acc = -Acc / 2 + LINE(7, 11611, 1192);
	WRITE_LINE(6, 10417) = Acc;
	Acc = LINE(6, 10417, 2510) * 0.625 + LINE(5, 7905, 1071) / 2;
	WRITE_LINE(5, 7905) = -Acc;
	Acc = -Acc / 2 + LINE(5, 7905, 1071);
	WRITE_LINE(4, 6832) = Acc;
	Acc = LINE(4, 6832, 1857) * 0.625 + LINE(3, 4973, 1212) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_18(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(8, 13793, 211) * 0.75 + LINE(6, 10673, 1391) * 0.75 + LINE(4, 6788, 1403) * 0.75;
	tmp_3 = Acc;
	Acc = LINE(8, 13793, 1101) * 0.75 + LINE(6, 10673, 690) * 0.75 + LINE(4, 6788, 471) * 0.75;
	tmp_5 = Acc;
	...
	Acc = Acc * -1.125 + LINE(9, 13939, 144) * 2.25;
	tmp_b = Acc;
	Acc = LINE(8, 13793, 1724) * 0.75 + LINE(7, 12067, 1392) / 2;
	WRITE_LINE(7, 12067) = -Acc;
	Acc = -Acc / 2 + LINE(7, 12067, 1392);
	WRITE_LINE(6, 10673) = Acc;
	Acc = LINE(6, 10673, 2510) * 0.625 + LINE(5, 8161, 1371) / 2;
	WRITE_LINE(5, 8161) = -Acc;
	Acc = -Acc / 2 + LINE(5, 8161, 1371);
	WRITE_LINE(4, 6788) = Acc;
	Acc = LINE(4, 6788, 1857) * 0.625 + LINE(3, 4929, 1512) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_19(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_1, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(10, 13254, 64) * 0.75 + LINE(8, 10744, 696) * 0.75 + LINE(4, 5956, 539) * 0.75 + LINE(0, 0, 178) * 0.75;
	tmp_5 = Acc;
	Acc = LINE(10, 13254, 503) * 0.75 + LINE(8, 10744, 167) * 0.75 + LINE(4, 5956, 151) * 0.75 + LINE(0, 0, 511) * 0.75;
	tmp_3 = Acc;
	Acc = LINE(15, 14382, 58) * 0.625 + LINE(0, 0, 2000) / 2;
	WRITE_LINE(15, 14382) = -Acc;
	Acc = LINE(14, 14322, 89) * 0.625 + LINE(15, 14382, 0) * 0.625 + LINE(15, 14382, 58);
	WRITE_LINE(14, 14322) = -Acc;
	Acc = LINE(13, 14231, 183) * 0.625 + LINE(14, 14322, 0) * 0.625 + LINE(14, 14322, 89);
	WRITE_LINE(13, 14231) = -Acc;
	Acc = LINE(12, 14046, 321) * 0.625 + LINE(13, 14231, 0) * 0.625 + LINE(13, 14231, 183);
	WRITE_LINE(12, 14046) = -Acc;
	Acc = LINE(11, 13723, 467) * 0.625 + LINE(12, 14046, 0) * 0.625 + LINE(12, 14046, 321);
	WRITE_LINE(11, 13723) = -Acc;
	Acc = Acc * -0.1875 + LINE(11, 13723, 0) * 0.75 + LINE(11, 13723, 467) * 1.5;
	tmp_b = Acc;
	Acc = LINE(10, 13254, 1385) * 0.75 + LINE(9, 11867, 1121) / 2;
	WRITE_LINE(9, 11867) = -Acc;
	Acc = -Acc / 2 + LINE(9, 11867, 1121);
	WRITE_LINE(8, 10744) = Acc;
	Acc = LINE(8, 10744, 1641) * 0.75 + LINE(7, 9101, 1020) / 2;
	...
	Acc = LINE(6, 8079, 1211) * 0.75 + LINE(5, 6866, 908) / 2;
	WRITE_LINE(5, 6866) = -Acc;
	Acc = -Acc / 2 + LINE(5, 6866, 908);
	WRITE_LINE(4, 5956) = Acc;
	Acc = LINE(4, 5956, 1417) * 0.75 + LINE(3, 4537, 1098) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_20(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_1, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(10, 15253, 64) * 0.75 + LINE(8, 13283, 696) * 0.75 + LINE(4, 8586, 539) * 0.75 + LINE(13, 16230, 24) * 0.75;
	tmp_5 = Acc;
	Acc = LINE(10, 15253, 503) * 0.75 + LINE(8, 13283, 167) * 0.75 + LINE(4, 8586, 151) * 0.75 + LINE(12, 16045, 172) * 0.75;
	tmp_3 = Acc;
	Acc = LINE(15, 16381, 58) * 0.625 + LINE(0, 0, 1) / 2;
	...
	Acc = Acc * -0.1875 + LINE(11, 15722, 0) * 0.75 + LINE(11, 15722, 467) * 1.5;
	tmp_b = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_21(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(17, 15822, 120) * 0.75 + LINE(16, 14952, 634) * 0.75 + LINE(15, 13905, 552) * 0.75 + LINE(14, 12769, 478) * 0.75 + LINE(9, 8225, 369) * 0.75 + LINE(8, 7182, 208) * 0.75 + LINE(7, 6199, 723) * 0.75;
	tmp_3 = Acc;
	Acc = LINE(17, 15822, 129) * 0.75 + LINE(16, 14952, 130) * 0.75 + LINE(15, 13905, 359) * 0.75 + LINE(14, 12769, 277) * 0.75 + LINE(9, 8225, 363) * 0.75 + LINE(8, 7182, 499) * 0.75 + LINE(6, 5096, 891) * 0.75;
	tmp_5 = Acc;
	...
	Acc = Acc * -0.75 + LINE(19, 16227, 125) * 0.75 + LINE(20, 16313, 84);
	WRITE_LINE(19, 16227) = -Acc;
	Acc = Acc * -0.75 + LINE(18, 16100, 276) * 0.75 + LINE(19, 16227, 125);
	WRITE_LINE(18, 16100) = -Acc;
	Acc = Acc * -0.75 + LINE(18, 16100, 276);
	tmp_b = Acc;
	Acc = LINE(17, 15822, 868) * 0.75 + LINE(13, 11800, 878) / 2;
	WRITE_LINE(13, 11800) = -Acc;
	Acc = -Acc / 2 + LINE(13, 11800, 878);
	WRITE_LINE(16, 14952) = Acc;
	Acc = LINE(16, 14952, 1045) * 0.75 + LINE(12, 10920, 712) / 2;
	...
	Acc = LINE(9, 8225, 1041) * 0.75 + LINE(5, 4084, 812) / 2;
	WRITE_LINE(5, 4084) = -Acc;
	Acc = -Acc / 2 + LINE(5, 4084, 812);
	WRITE_LINE(8, 7182) = Acc;
	Acc = LINE(8, 7182, 981) * 0.75 + LINE(4, 3270, 981) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_22(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(17, 15822, 420) * 0.75 + LINE(16, 14617, 634) * 0.75 + LINE(15, 13570, 552) * 0.75 + LINE(14, 12434, 478) * 0.75 + LINE(9, 9099, 269) * 0.75 + LINE(8, 8056, 208) * 0.75 + LINE(7, 7073, 723) * 0.75;
	tmp_3 = Acc;
	Acc = LINE(17, 15822, 129) * 0.75 + LINE(16, 14617, 130) * 0.75 + LINE(15, 13570, 359) * 0.75 + LINE(14, 12434, 277) * 0.75 + LINE(9, 9099, 363) * 0.75 + LINE(8, 8056, 499) * 0.75 + LINE(6, 5970, 891) * 0.75;
	tmp_5 = Acc;
	...
	Acc = Acc * -0.75 + LINE(18, 16100, 276);
	tmp_b = Acc;
	Acc = LINE(17, 15822, 1203) * 0.75 + LINE(13, 11465, 578) / 2;
	WRITE_LINE(13, 11465) = -Acc;
	Acc = -Acc / 2 + LINE(13, 11465, 578);
	WRITE_LINE(16, 14617) = Acc;
	Acc = LINE(16, 14617, 1045) * 0.75 + LINE(12, 10885, 712) / 2;
	...
	WRITE_LINE(17, 15822) = Acc;
	Acc = LINE(9, 9099, 1041) * 0.75 + LINE(5, 4958, 612) / 2;
	WRITE_LINE(5, 4958) = -Acc;
	Acc = -Acc / 2 + LINE(5, 4958, 612);
	WRITE_LINE(8, 8056) = Acc;
	Acc = LINE(8, 8056, 981) * 0.75 + LINE(4, 4344, 781) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_23(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(8, 13326, 567) * 1.125 + LINE(6, 9506, 1891) * 1.125 + LINE(4, 5621, 2003) * 1.125;
	tmp_3 = Acc;
	Acc = LINE(8, 13326, 1190) * 1.125 + LINE(6, 9506, 890) * 1.125 + LINE(4, 5621, 671) * 1.125;
	tmp_5 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_24(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(8, 12327, 567) * 1.125 + LINE(6, 9007, 1891) * 1.125 + LINE(4, 5159, 2003) * 1.125;
	tmp_3 = Acc;
	Acc = LINE(8, 12327, 567) * 1.125 + LINE(6, 9007, 890) * 1.125 + LINE(4, 5159, 671) * 1.125;
	tmp_5 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_25(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(8, 13326, 567) * 1.125 + LINE(6, 9506, 1891) * 1.125 + LINE(4, 5621, 2003) * 1.125;
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_26(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(8, 13526, 567) * 1.125 + LINE(6, 10206, 1891) * 1.125 + LINE(4, 6321, 2003) * 1.125;
	tmp_3 = Acc;
	Acc = LINE(8, 13526, 567) * 1.125 + LINE(6, 10206, 890) * 1.125 + LINE(4, 6321, 671) * 1.125;
	tmp_5 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_27(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(16, 15922, 420) * 1.125 + LINE(15, 14952, 334) * 1.125 + LINE(14, 13863, 252) * 1.125 + LINE(13, 12452, 478) * 1.125 + LINE(8, 8583, 369) * 1.125 + LINE(7, 7708, 499) * 1.125 + LINE(6, 6472, 323) * 1.125;
	tmp_3 = Acc;
	Acc = LINE(16, 15922, 129) * 1.125 + LINE(15, 14952, 130) * 1.125 + LINE(14, 13863, 459) * 1.125 + LINE(13, 12452, 277) * 1.125 + LINE(8, 8583, 363) * 1.125 + LINE(7, 7708, 208) * 1.125 + LINE(5, 5025, 491) * 1.125;
	tmp_5 = Acc;
	Acc = LINE(21, 16381, 19) * 0.75 + LINE(0, 0, 1) / 2;
	WRITE_LINE(21, 16381) = -Acc;
	Acc = Acc * -0.75 + LINE(20, 16360, 45) * 0.75 + LINE(21, 16381, 19);
	...
	Acc = LINE(14, 13863, 1409) * 0.75 + LINE(10, 9374, 356) / 2;
	WRITE_LINE(10, 9374) = -Acc;
	Acc = -Acc / 2 + LINE(10, 9374, 356);
	WRITE_LINE(13, 12452) = Acc;
	Acc = LINE(13, 12452, 1404) * 0.75 + LINE(9, 9016, 431) / 2;
	...
	*out_left = tmp_5;
	Acc = LINE(6, 6472, 1445) * 0.75 + LINE(2, 1741, 634) / 2;
	WRITE_LINE(2, 1741) = -Acc;
	Acc = -Acc / 2 + LINE(2, 1741, 634);
	WRITE_LINE(5, 5025) = Acc;
	Acc = LINE(5, 5025, 1610) * 0.75 + LINE(1, 1105, 432) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_28(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(7, 13341, 21) * 1.125 + LINE(5, 9321, 1891) * 1.125 + LINE(3, 5236, 2003) * 1.125;
	tmp_3 = Acc;
	Acc = LINE(7, 13341, 1010) * 1.125 + LINE(5, 9321, 890) * 1.125 + LINE(3, 5236, 671) * 1.125;
	tmp_5 = Acc;
	...
	Acc = LINE(5, 9321, 2810) * 0.9375 + LINE(4, 6509, 1271) / 2;
	WRITE_LINE(4, 6509) = -Acc;
	Acc = -Acc / 2 + LINE(4, 6509, 1271);
	WRITE_LINE(3, 5236) = Acc;
	Acc = LINE(3, 5236, 3857) * 0.75 + LINE(2, 1377, 1112) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_29(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(7, 12741, 21) * 1.125 + LINE(5, 9121, 1891) * 1.125 + LINE(3, 4636, 2003) * 1.125;
	tmp_3 = Acc;
	Acc = LINE(7, 12741, 1010) * 1.125 + LINE(5, 9121, 890) * 1.125 + LINE(3, 4636, 671) * 1.125;
	tmp_5 = Acc;
	Acc = LINE(15, 16381, 321) / 2 + LINE(0, 0, 1) / 2;
	WRITE_LINE(15, 16381) = -Acc;
	Acc = -Acc / 2 + LINE(15, 16381, 321) + LINE(14, 16058, 431) / 2;
	...
	Acc = LINE(5, 9121, 2110) * 0.9375 + LINE(4, 7009, 2371) / 2;
	WRITE_LINE(4, 7009) = -Acc;
	Acc = -Acc / 2 + LINE(4, 7009, 2371);
	WRITE_LINE(3, 4636) = Acc;
	Acc = LINE(3, 4636, 2157) * 0.9375 + LINE(2, 2477, 2212) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_30(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5, tmp_b, tmp_15;
	WRITE_LINE(0, 0) = input;
	...
	tmp_b = -Acc;
	Acc = -Acc / 8 + LINE(17, 7382, 245) * 0.625 + tmp_b / 2;
	WRITE_LINE(17, 7382) = -Acc;
	Acc = -Acc / 8 + LINE(16, 7135, 189) * 0.625 + LINE(17, 7382, 0) / 2 + LINE(17, 7382, 245);
	WRITE_LINE(16, 7135) = -Acc;
	Acc = -Acc / 8 + LINE(15, 6944, 145) * 0.625 + LINE(16, 7135, 0) / 2 + LINE(16, 7135, 189);
	WRITE_LINE(15, 6944) = -Acc;
	Acc = -Acc / 8 + LINE(14, 6797, 123) * 0.625 + LINE(15, 6944, 0) / 2 + LINE(15, 6944, 145);
	WRITE_LINE(14, 6797) = -Acc;
	Acc = -Acc / 8 + LINE(13, 6672, 198) * 0.625 + LINE(14, 6797, 0) / 2 + LINE(14, 6797, 123);
	...
	Acc = LINE(6, 5375, 1010) * 0.75 + LINE(5, 4363, 289) / 2;
	...
	*out_left = tmp_5;
	...
	Acc = LINE(2, 3222, 1071) * 0.75 + LINE(1, 2149, 225) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_31(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5, tmp_b, tmp_15;
	WRITE_LINE(0, 0) = input;
	...
	Acc = -Acc / 2 + LINE(9, 6259, 148);
	tmp_15 = -Acc;
	Acc = LINE(8, 6109, 1123) * 0.75 + LINE(7, 4984, 233) / 2;
	...
	WRITE_LINE(8, 6109) = -Acc;
	*out_left = tmp_5;
	Acc = LINE(4, 3446, 990) * 0.75 + LINE(3, 2454, 256) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_32(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5, tmp_b, tmp_15;
	WRITE_LINE(0, 0) = input;
	...
	tmp_b = -Acc;
	Acc = -Acc / 8 + LINE(17, 10382, 245) * 0.625 + tmp_b / 2;
	WRITE_LINE(17, 10382) = -Acc;
	Acc = -Acc / 8 + LINE(16, 10135, 189) * 0.625 + LINE(17, 10382, 0) / 2 + LINE(17, 10382, 245);
	WRITE_LINE(16, 10135) = -Acc;
	Acc = -Acc / 8 + LINE(15, 9944, 189) * 0.625 + LINE(16, 10135, 0) / 2 + LINE(16, 10135, 189);
	WRITE_LINE(15, 9944) = -Acc;
	Acc = -Acc / 8 + LINE(14, 9753, 223) * 0.625 + LINE(15, 9944, 0) / 2 + LINE(15, 9944, 189);
	WRITE_LINE(14, 9753) = -Acc;
	Acc = -Acc / 8 + LINE(13, 9528, 298) * 0.625 + LINE(14, 9753, 0) / 2 + LINE(14, 9753, 223);
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_33(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5, tmp_b, tmp_15;
	WRITE_LINE(0, 0) = input;
	...
	tmp_b = -Acc;
	Acc = -Acc / 8 + LINE(18, 7382, 245) * 0.625 + tmp_b / 2;
	WRITE_LINE(18, 7382) = -Acc;
	Acc = -Acc / 8 + LINE(17, 7135, 189) * 0.625 + LINE(18, 7382, 0) / 2 + LINE(18, 7382, 245);
	WRITE_LINE(17, 7135) = -Acc;
	Acc = -Acc / 8 + LINE(16, 6944, 145) * 0.625 + LINE(17, 7135, 0) / 2 + LINE(17, 7135, 189);
	WRITE_LINE(16, 6944) = -Acc;
	Acc = -Acc / 8 + LINE(15, 6797, 123) * 0.625 + LINE(16, 6944, 0) / 2 + LINE(16, 6944, 145);
	WRITE_LINE(15, 6797) = -Acc;
	Acc = -Acc / 8 + LINE(14, 6672, 198) * 0.625 + LINE(15, 6797, 0) / 2 + LINE(15, 6797, 123);
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_34(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5, tmp_b, tmp_15;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(8, 6109, 123) / 2 + LINE(6, 4749, 361) / 2 + LINE(4, 3446, 205) / 2 + LINE(2, 2196, 861) / 2;
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_35(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	...
	Acc = Acc * -1.125 + LINE(7, 2110, 273) * 2.25;
	tmp_3 = -Acc;
	...
	Acc = Acc * -1.125 + LINE(4, 1608, 233) * 2.25;
	tmp_5 = -Acc;
	Acc = LINE(0, 0, 0) / 2 + LINE(0, 0, 1) / 2;
	WRITE_LINE(0, 0) = Acc;
	Acc = LINE(0, 0, 10) * -0.375;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_36(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5;
	tmp_0 = input;
	Acc = tmp_0;
	...
	Acc = Acc * -0.75 + LINE(5, 2220, 173) * 1.5;
	tmp_3 = Acc;
	...
	Acc = Acc * -0.75 + LINE(2, 1934, 133) * 1.5;
	tmp_5 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_37(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5;
	tmp_0 = input;
	...
	Acc = Acc * -1.125 + LINE(7, 6110, 273) * 2.25;
	tmp_3 = -Acc;
	...
	Acc = Acc * -1.125 + LINE(4, 5608, 233) * 2.25;
	tmp_5 = -Acc;
	Acc = tmp_0;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_38(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5;
	tmp_0 = input;
	...
	Acc = Acc * -0.75 + LINE(4, 2220, 173) * 1.5;
	tmp_3 = Acc;
	...
	Acc = Acc * -0.75 + LINE(1, 1934, 133) * 1.5;
	tmp_5 = Acc;
	Acc = LINE(8, 16382, 1) * 0.75 + tmp_0 / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_39(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5;
	tmp_0 = input;
	...
	Acc = Acc * -1.125 + LINE(6, 2110, 273) * 2.25;
	tmp_3 = -Acc;
	...
	Acc = Acc * -1.125 + LINE(3, 1608, 233) * 2.25;
	tmp_5 = -Acc;
	Acc = LINE(11, 16382, 1) * 0.75 + tmp_0 / 2;
	WRITE_LINE(11, 16382) = Acc;
	Acc = LINE(11, 16382, 8) * -0.375;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_40(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5;
	tmp_0 = input;
	...
	Acc = Acc * -1.125 + LINE(7, 2112, 213) * 2.25 + LINE(10, 16382, 11316) * 2.25;
	tmp_3 = -Acc;
	...
	Acc = Acc * -1.125 + LINE(4, 1726, 189) * 2.25 + LINE(10, 16382, 11316) * 2.25;
	tmp_5 = -Acc;
	Acc = tmp_0 / 2;
	...
	Acc = Acc * 0.09375 + LINE(10, 16382, 3119) / 32 + LINE(10, 16382, 3265) / 32 + LINE(10, 16382, 3449) / 32 + LINE(10, 16382, 3567) / 32 + LINE(10, 16382, 5032) / 32 + LINE(10, 16382, 3887) / 32 + LINE(10, 16382, 4032) / 32 + -LINE(10, 16382, 4725) / 16 + -LINE(10, 16382, 4255) / 16 + -LINE(10, 16382, 4490) / 16 + -LINE(10, 16382, 4554) / 16 + -LINE(10, 16382, 4847) / 16 + -LINE(10, 16382, 3723) / 16 + LINE(10, 16382, 5127) / 8 + LINE(10, 16382, 5233) / 8 + LINE(10, 16382, 5419) / 8 + LINE(10, 16382, 5532) / 8 + LINE(10, 16382, 5757) / 8 + LINE(10, 16382, 6857) / 8 + -LINE(10, 16382, 6033) / 4 + -LINE(10, 16382, 6157) / 4 + -LINE(10, 16382, 6221) / 4 + -LINE(10, 16382, 7124) / 4 + LINE(2, 1532, 1) / 2;
	WRITE_LINE(2, 1532) = Acc;
	*out_left = tmp_5;
	Acc = Acc * 0.375 + LINE(10, 16382, 6532) / 8 + LINE(10, 16382, 6780) / 8 + LINE(10, 16382, 5835) / 8 + LINE(10, 16382, 7037) / 8 + LINE(10, 16382, 6444) / 8 + LINE(10, 16382, 7219) / 8 + LINE(10, 16382, 7437) / 8 + -LINE(10, 16382, 7734) / 4 + -LINE(10, 16382, 7889) / 4 + -LINE(10, 16382, 8032) / 4 + -LINE(10, 16382, 9213) / 4 + -LINE(10, 16382, 8445) / 4 + -LINE(10, 16382, 8563) / 4 + -LINE(10, 16382, 9511) / 4 + LINE(1, 1529, 1) / 2;
	WRITE_LINE(1, 1529) = Acc;
	*out_right = tmp_3;
	Acc = Acc * -0.75 + -LINE(10, 16382, 8883) / 4 + -LINE(10, 16382, 9010) / 4 + -LINE(10, 16382, 9169) / 4 + -LINE(10, 16382, 8144) / 4 + -LINE(10, 16382, 9447) / 4 + -LINE(10, 16382, 8698) / 4 + -LINE(10, 16382, 9763) / 4 + -LINE(10, 16382, 9865) / 4 + -LINE(10, 16382, 10044) / 4 + -LINE(10, 16382, 10108) / 4 + LINE(10, 16382, 10283) / 2 + LINE(10, 16382, 10426) / 2 + LINE(10, 16382, 10576) / 2 + LINE(10, 16382, 10732) / 2 + LINE(10, 16382, 10813) / 2 + LINE(10, 16382, 11021) / 2 + LINE(10, 16382, 11252) / 2;
	WRITE_LINE(0, 11) = Acc;
}
#undef LINE
#undef WRITE_LINE
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_41(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_42(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(1, 11, 2) / 2 + LINE(7, 2298, 21) / 2;
	WRITE_LINE(7, 2298) = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_43(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(1, 11, 2) / 2 + LINE(7, 2298, 21) / 2;
	WRITE_LINE(7, 2298) = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_44(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(1, 11, 2) / 2 + LINE(7, 2298, 21) / 2;
	WRITE_LINE(7, 2298) = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_45(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(4, 2190, 1);
	tmp_3 = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_46(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 0);
	...
	Acc = Acc * -1.125 + LINE(9, 4012, 313) * 2.25 + LINE(12, 16373, 11307) * 2.25;
	tmp_3 = -Acc;
	...
	Acc = Acc * -1.125 + LINE(6, 3466, 289) * 2.25 + LINE(12, 16373, 11307) * 2.25;
	tmp_5 = -Acc;
	Acc = LINE(0, 0, 10) / 2;
	WRITE_LINE(12, 16373) = Acc;
	Acc = Acc * -0.1875 + -LINE(12, 16373, 401) / 16 + -LINE(12, 16373, 750) / 16 + -LINE(12, 16373, 1054) / 16 + LINE(12, 16373, 1222) / 8 + LINE(12, 16373, 1423) / 8 + LINE(12, 16373, 1731) / 8 + LINE(12, 16373, 1851) / 8 + LINE(12, 16373, 2138) / 8 + -LINE(12, 16373, 2245) / 4 + -LINE(12, 16373, 2432) / 4 + -LINE(12, 16373, 1544) / 4 + -LINE(12, 16373, 2710) / 4 + -LINE(12, 16373, 2862) / 4 + -LINE(12, 16373, 2035) / 4 + LINE(5, 3175, 1) / 2;
	WRITE_LINE(5, 3175) = Acc;
	Acc = Acc * 0.09375 + LINE(12, 16373, 3110) / 32 + LINE(12, 16373, 3256) / 32 + LINE(12, 16373, 3558) / 32 + LINE(12, 16373, 5023) / 32 + LINE(12, 16373, 3878) / 32 + LINE(12, 16373, 4023) / 32 + -LINE(12, 16373, 4716) / 16 + -LINE(12, 16373, 4246) / 16 + -LINE(12, 16373, 4481) / 16 + -LINE(12, 16373, 4838) / 16 + -LINE(12, 16373, 3714) / 16 + LINE(12, 16373, 5118) / 8 + LINE(12, 16373, 5224) / 8 + LINE(12, 16373, 5410) / 8 + LINE(12, 16373, 5523) / 8 + LINE(12, 16373, 5748) / 8 + LINE(12, 16373, 6848) / 8 + -LINE(12, 16373, 6024) / 4 + -LINE(12, 16373, 6212) / 4 + -LINE(12, 16373, 7115) / 4 + LINE(4, 3172, 1) / 2;
	WRITE_LINE(4, 3172) = Acc;
	*out_left = tmp_5;
	Acc = Acc * 0.375 + LINE(12, 16373, 6523) / 8 + LINE(12, 16373, 5826) / 8 + LINE(12, 16373, 7028) / 8 + LINE(12, 16373, 6435) / 8 + LINE(12, 16373, 7210) / 8 + LINE(12, 16373, 7428) / 8 + -LINE(12, 16373, 7725) / 4 + -LINE(12, 16373, 7880) / 4 + -LINE(12, 16373, 8023) / 4 + -LINE(12, 16373, 9204) / 4 + -LINE(12, 16373, 8436) / 4 + -LINE(12, 16373, 8554) / 4 + -LINE(12, 16373, 9502) / 4 + LINE(3, 3169, 1) / 2;
	WRITE_LINE(3, 3169) = Acc;
	*out_right = tmp_3;
	Acc = Acc * -0.75 + -LINE(12, 16373, 8874) / 4 + -LINE(12, 16373, 9001) / 4 + -LINE(12, 16373, 9160) / 4 + -LINE(12, 16373, 8135) / 4 + -LINE(12, 16373, 9438) / 4 + -LINE(12, 16373, 8689) / 4 + -LINE(12, 16373, 9754) / 4 + -LINE(12, 16373, 9856) / 4 + -LINE(12, 16373, 10035) / 4 + -LINE(12, 16373, 10099) / 4 + LINE(12, 16373, 10274) / 2 + LINE(12, 16373, 10417) / 2 + LINE(12, 16373, 10567) / 2 + LINE(12, 16373, 10723) / 2 + LINE(12, 16373, 10804) / 2 + LINE(12, 16373, 11012) / 2 + LINE(12, 16373, 11243) / 2;
	WRITE_LINE(1, 11) = -Acc;
}
#undef LINE
#undef WRITE_LINE
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_47(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5;
	tmp_0 = input;
	Acc = LINE(0, 11, 2) / 2 + LINE(9, 2298, 51) / 2;
	WRITE_LINE(9, 2298) = -Acc;
	...
	Acc = -Acc / 2 + LINE(8, 2245, 131) + LINE(7, 2112, 213) / 2;
	WRITE_LINE(7, 2112) = -Acc;
	Acc = Acc * -1.125 + LINE(7, 2112, 213) * 2.25 + LINE(10, 16373, 11307) * 2.25;
	tmp_3 = -Acc;
	Acc = LINE(0, 11, 2) / 2 + LINE(6, 1897, 62) / 2;
	WRITE_LINE(6, 1897) = -Acc;
	Acc = -Acc / 2 + LINE(6, 1897, 62) + LINE(5, 1833, 105) / 2;
	...
	Acc = -Acc / 2 + LINE(5, 1833, 105) + LINE(4, 1726, 189) / 2;
	WRITE_LINE(4, 1726) = -Acc;
	Acc = Acc * -1.125 + LINE(4, 1726, 189) * 2.25 + LINE(10, 16373, 11307) * 2.25;
	tmp_5 = -Acc;
	...
	WRITE_LINE(3, 1535) = Acc;
	Acc = Acc * 0.09375 + LINE(10, 16373, 3110) / 32 + LINE(10, 16373, 3256) / 32 + LINE(10, 16373, 3440) / 32 + LINE(10, 16373, 3558) / 32 + LINE(10, 16373, 5023) / 32 + LINE(10, 16373, 3878) / 32 + LINE(10, 16373, 4023) / 32 + -LINE(10, 16373, 4716) / 16 + -LINE(10, 16373, 4246) / 16 + -LINE(10, 16373, 4481) / 16 + -LINE(10, 16373, 4545) / 16 + -LINE(10, 16373, 4838) / 16 + -LINE(10, 16373, 3714) / 16 + LINE(10, 16373, 5118) / 8 + LINE(10, 16373, 5224) / 8 + LINE(10, 16373, 5410) / 8 + LINE(10, 16373, 5523) / 8 + LINE(10, 16373, 5748) / 8 + LINE(10, 16373, 6848) / 8 + -LINE(10, 16373, 6024) / 4 + -LINE(10, 16373, 6148) / 4 + -LINE(10, 16373, 6212) / 4 + -LINE(10, 16373, 7115) / 4 + LINE(2, 1532, 1) / 2;
	WRITE_LINE(2, 1532) = Acc;
	*out_left = tmp_5;
	Acc = Acc * 0.375 + LINE(10, 16373, 6523) / 8 + LINE(10, 16373, 6771) / 8 + LINE(10, 16373, 5826) / 8 + LINE(10, 16373, 7028) / 8 + LINE(10, 16373, 6435) / 8 + LINE(10, 16373, 7210) / 8 + LINE(10, 16373, 7428) / 8 + -LINE(10, 16373, 7725) / 4 + -LINE(10, 16373, 7880) / 4 + -LINE(10, 16373, 8023) / 4 + -LINE(10, 16373, 9204) / 4 + -LINE(10, 16373, 8436) / 4 + -LINE(10, 16373, 8554) / 4 + -LINE(10, 16373, 9502) / 4 + LINE(1, 1529, 1) / 2;
	WRITE_LINE(1, 1529) = Acc;
	*out_right = tmp_3;
	Acc = Acc * -0.75 + -LINE(10, 16373, 8874) / 4 + -LINE(10, 16373, 9001) / 4 + -LINE(10, 16373, 9160) / 4 + -LINE(10, 16373, 8135) / 4 + -LINE(10, 16373, 9438) / 4 + -LINE(10, 16373, 8689) / 4 + -LINE(10, 16373, 9754) / 4 + -LINE(10, 16373, 9856) / 4 + -LINE(10, 16373, 10035) / 4 + -LINE(10, 16373, 10099) / 4 + LINE(10, 16373, 10274) / 2 + LINE(10, 16373, 10417) / 2 + LINE(10, 16373, 10567) / 2 + LINE(10, 16373, 10723) / 2 + LINE(10, 16373, 10804) / 2 + LINE(10, 16373, 11012) / 2 + LINE(10, 16373, 11243) / 2;
	WRITE_LINE(0, 11) = Acc;
}
#undef LINE
#undef WRITE_LINE
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_48(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	...
	Acc = Acc * -1.125 + LINE(9, 2112, 213) * 2.25 + LINE(12, 16364, 11298) * 2.25;
	tmp_3 = -Acc;
	...
	Acc = Acc * -1.125 + LINE(6, 1726, 189) * 2.25 + LINE(12, 16364, 11298) * 2.25;
	tmp_5 = -Acc;
	Acc = LINE(0, 0, 3);
	WRITE_LINE(2, 1526) = -Acc;
	Acc = LINE(2, 1526, 1300);
	WRITE_LINE(13, 16380) = -Acc;
	Acc = LINE(12, 16364, 11298) * 0.75 + LINE(0, 0, 0) / 2;
	...
	Acc = Acc * 0.09375 + LINE(12, 16364, 3101) / 32 + LINE(12, 16364, 3549) / 32 + LINE(12, 16364, 5014) / 32 + LINE(12, 16364, 3869) / 32 + LINE(12, 16364, 4014) / 32 + -LINE(12, 16364, 4707) / 16 + -LINE(12, 16364, 4237) / 16 + -LINE(12, 16364, 4472) / 16 + -LINE(12, 16364, 4536) / 16 + -LINE(12, 16364, 4829) / 16 + -LINE(12, 16364, 3705) / 16 + LINE(12, 16364, 5109) / 8 + LINE(12, 16364, 5215) / 8 + LINE(12, 16364, 5401) / 8 + LINE(12, 16364, 5514) / 8 + LINE(12, 16364, 5739) / 8 + LINE(12, 16364, 6839) / 8 + -LINE(12, 16364, 6015) / 4 + -LINE(12, 16364, 6139) / 4 + -LINE(12, 16364, 6203) / 4 + -LINE(12, 16364, 7106) / 4 + LINE(4, 1532, 1) / 2;
	WRITE_LINE(4, 1532) = Acc;
	*out_left = tmp_5;
	Acc = Acc * 0.375 + LINE(12, 16364, 6514) / 8 + LINE(12, 16364, 6762) / 8 + LINE(12, 16364, 5817) / 8 + LINE(12, 16364, 7019) / 8 + LINE(12, 16364, 6426) / 8 + LINE(12, 16364, 7201) / 8 + LINE(12, 16364, 7419) / 8 + -LINE(12, 16364, 7716) / 4 + -LINE(12, 16364, 7871) / 4 + -LINE(12, 16364, 8014) / 4 + -LINE(12, 16364, 9195) / 4 + -LINE(12, 16364, 8427) / 4 + -LINE(12, 16364, 8545) / 4 + -LINE(12, 16364, 9493) / 4 + LINE(3, 1529, 1) / 2;
	WRITE_LINE(3, 1529) = Acc;
	*out_right = tmp_3;
	Acc = Acc * -0.75 + -LINE(12, 16364, 8865) / 4 + -LINE(12, 16364, 8992) / 4 + -LINE(12, 16364, 9151) / 4 + -LINE(12, 16364, 8126) / 4 + -LINE(12, 16364, 9429) / 4 + -LINE(12, 16364, 8680) / 4 + -LINE(12, 16364, 9745) / 4 + -LINE(12, 16364, 9847) / 4 + -LINE(12, 16364, 10026) / 4 + -LINE(12, 16364, 10090) / 4 + LINE(12, 16364, 10265) / 2 + LINE(12, 16364, 10408) / 2 + LINE(12, 16364, 10558) / 2 + LINE(12, 16364, 10714) / 2 + LINE(12, 16364, 10795) / 2 + LINE(12, 16364, 11003) / 2 + LINE(12, 16364, 11234) / 2;
	WRITE_LINE(1, 11) = Acc;
}
#undef LINE
#undef WRITE_LINE
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_49(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(4, 191, 1);
	tmp_3 = -Acc;
	...
	Acc = Acc * 1.5 + LINE(5, 194, 1) + LINE(26, 14382, 13) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_50(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5;
	tmp_0 = input;
	Acc = tmp_0;
	...
	Acc = LINE(1, 16282, 5);
	tmp_3 = Acc;
	Acc = LINE(1, 16282, 1) * 0.017578125 + LINE(1, 16282, 10) * 0.017578125 + LINE(1, 16282, 2) * -0.03515625 + LINE(1, 16282, 9) * -0.03515625 + LINE(1, 16282, 3) * 0.0703125 + LINE(1, 16282, 8) * 0.0703125 + LINE(1, 16282, 4) * -0.140625 + LINE(1, 16282, 7) * -0.140625 + LINE(1, 16282, 5) * 0.421875 + LINE(1, 16282, 6) * 0.421875;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_51(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5, tmp_fa2, tmp_fa3, tmp_fa5, tmp_1f42, tmp_1f43, tmp_1f45;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
	Acc = LINE(1, 16282, 1) * 0.0263671875 + LINE(1, 16282, 10) * 0.0263671875 + LINE(1, 16282, 2) * -0.052734375 + LINE(1, 16282, 9) * -0.052734375 + LINE(1, 16282, 3) * 0.10546875 + LINE(1, 16282, 8) * 0.10546875 + LINE(1, 16282, 4) * -0.2109375 + LINE(1, 16282, 7) * -0.2109375 + LINE(1, 16282, 5) * 0.6328125 + LINE(1, 16282, 6) * 0.6328125;
	tmp_1f45 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_52(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5, tmp_fa2, tmp_fa3, tmp_fa5, tmp_1f42, tmp_1f43, tmp_1f45;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_53(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5, tmp_fa2, tmp_fa3, tmp_fa5, tmp_1f42, tmp_1f43, tmp_1f45;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_54(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5, tmp_fa3, tmp_fa5, tmp_1f43, tmp_1f45;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
	Acc = LINE(1, 16282, 1) * 0.0263671875 + LINE(1, 16282, 10) * 0.0263671875 + LINE(1, 16282, 2) * -0.052734375 + LINE(1, 16282, 9) * -0.052734375 + LINE(1, 16282, 3) * 0.10546875 + LINE(1, 16282, 8) * 0.10546875 + LINE(1, 16282, 4) * -0.2109375 + LINE(1, 16282, 7) * -0.2109375 + LINE(1, 16282, 5) * 0.6328125 + LINE(1, 16282, 6) * 0.6328125;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_55(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5, tmp_fa3, tmp_fa4, tmp_fa5, tmp_1f43, tmp_1f44, tmp_1f45;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
	Acc = LINE(1, 16282, 1) * 0.0263671875 + LINE(1, 16282, 10) * 0.0263671875 + LINE(1, 16282, 2) * -0.052734375 + LINE(1, 16282, 9) * -0.052734375 + LINE(1, 16282, 3) * 0.10546875 + LINE(1, 16282, 8) * 0.10546875 + LINE(1, 16282, 4) * -0.2109375 + LINE(1, 16282, 7) * -0.2109375 + LINE(1, 16282, 5) * 0.6328125 + LINE(1, 16282, 6) * 0.6328125;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_56(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5, tmp_fa3, tmp_fa4, tmp_fa5, tmp_1f43, tmp_1f44, tmp_1f45;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_57(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5, tmp_fa3, tmp_fa4, tmp_fa5, tmp_1f43, tmp_1f44, tmp_1f45;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_58(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5, tmp_fa5, tmp_1f45;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
	Acc = LINE(1, 16282, 1) * 0.0263671875 + LINE(1, 16282, 10) * 0.0263671875 + LINE(1, 16282, 2) * -0.052734375 + LINE(1, 16282, 9) * -0.052734375 + LINE(1, 16282, 3) * 0.10546875 + LINE(1, 16282, 8) * 0.10546875 + LINE(1, 16282, 4) * -0.2109375 + LINE(1, 16282, 7) * -0.2109375 + LINE(1, 16282, 5) * 0.6328125 + LINE(1, 16282, 6) * 0.6328125;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_59(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5, tmp_fa5, tmp_fa6, tmp_fa7, tmp_1f45, tmp_1f46, tmp_1f47;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
	Acc = LINE(1, 16282, 1) * 0.0263671875 + LINE(1, 16282, 10) * 0.0263671875 + LINE(1, 16282, 2) * -0.052734375 + LINE(1, 16282, 9) * -0.052734375 + LINE(1, 16282, 3) * 0.10546875 + LINE(1, 16282, 8) * 0.10546875 + LINE(1, 16282, 4) * -0.2109375 + LINE(1, 16282, 7) * -0.2109375 + LINE(1, 16282, 5) * 0.6328125 + LINE(1, 16282, 6) * 0.6328125;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_60(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5, tmp_fa5, tmp_fa6, tmp_fa7, tmp_1f45, tmp_1f46, tmp_1f47;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_61(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5, tmp_fa5, tmp_fa6, tmp_fa7, tmp_1f45, tmp_1f46, tmp_1f47;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_62(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5, tmp_fa5, tmp_fa7, tmp_1f45, tmp_1f47;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
	Acc = LINE(1, 16282, 1) * 0.0263671875 + LINE(1, 16282, 10) * 0.0263671875 + LINE(1, 16282, 2) * -0.052734375 + LINE(1, 16282, 9) * -0.052734375 + LINE(1, 16282, 3) * 0.10546875 + LINE(1, 16282, 8) * 0.10546875 + LINE(1, 16282, 4) * -0.2109375 + LINE(1, 16282, 7) * -0.2109375 + LINE(1, 16282, 5) * 0.6328125 + LINE(1, 16282, 6) * 0.6328125;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_63(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5, tmp_fa5, tmp_fa7, tmp_fa8, tmp_1f45, tmp_1f47, tmp_1f48;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
	Acc = LINE(1, 16282, 1) * 0.0263671875 + LINE(1, 16282, 10) * 0.0263671875 + LINE(1, 16282, 2) * -0.052734375 + LINE(1, 16282, 9) * -0.052734375 + LINE(1, 16282, 3) * 0.10546875 + LINE(1, 16282, 8) * 0.10546875 + LINE(1, 16282, 4) * -0.2109375 + LINE(1, 16282, 7) * -0.2109375 + LINE(1, 16282, 5) * 0.6328125 + LINE(1, 16282, 6) * 0.6328125;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_64(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5, tmp_fa5, tmp_fa7, tmp_fa8, tmp_1f45, tmp_1f47, tmp_1f48;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_65(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5, tmp_fa5, tmp_fa7, tmp_fa8, tmp_1f45, tmp_1f47, tmp_1f48;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_66(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
	Acc = LINE(1, 16282, 6);
	tmp_3 = Acc;
	Acc = LINE(1, 16282, 2) * 0.017578125 + LINE(1, 16282, 11) * 0.017578125 + LINE(1, 16282, 3) * -0.03515625 + LINE(1, 16282, 10) * -0.03515625 + LINE(1, 16282, 4) * 0.0703125 + LINE(1, 16282, 9) * 0.0703125 + LINE(1, 16282, 5) * -0.140625 + LINE(1, 16282, 8) * -0.140625 + LINE(1, 16282, 6) * 0.421875 + LINE(1, 16282, 7) * 0.421875;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_67(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5, tmp_fa1, tmp_fa2, tmp_fa4, tmp_1f41, tmp_1f42, tmp_1f44;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
	Acc = LINE(1, 16282, 2) * 0.0263671875 + LINE(1, 16282, 11) * 0.0263671875 + LINE(1, 16282, 3) * -0.052734375 + LINE(1, 16282, 10) * -0.052734375 + LINE(1, 16282, 4) * 0.10546875 + LINE(1, 16282, 9) * 0.10546875 + LINE(1, 16282, 5) * -0.2109375 + LINE(1, 16282, 8) * -0.2109375 + LINE(1, 16282, 6) * 0.6328125 + LINE(1, 16282, 7) * 0.6328125;
	tmp_1f44 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_68(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_69(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_0, tmp_3, tmp_5;
	tmp_0 = input;
	Acc = tmp_0;
	WRITE_LINE(1, 16282) = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_70(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 1172);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_71(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 1758);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_72(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 2344);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_73(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 3516);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_74(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 4688);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_75(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 4922);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_76(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 5156);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_77(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 5391);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_78(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 5625);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_79(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 5859);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_80(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 6094);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_81(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 6328);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_82(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 6563);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_83(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 6797);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_84(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 7031);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_85(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 7500);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_86(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 7969);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_87(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 9141);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_88(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 11719);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_89(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 14063);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_90(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_91(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_92(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_93(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_94(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_95(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(0, 0, 150);
	tmp_3 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_96(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_97(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_98(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb2_f_effect_99(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#undef LINE
#undef WRITE_LINE
void (*midiverb2_f_effects[])(float input, float *out_left, float *out_right, float *DRAM, int ptr) = {
	midiverb2_f_effect_0,
	midiverb2_f_effect_1,
	midiverb2_f_effect_2,
	midiverb2_f_effect_3,
	midiverb2_f_effect_4,
	midiverb2_f_effect_5,
	midiverb2_f_effect_6,
	midiverb2_f_effect_7,
	midiverb2_f_effect_8,
	midiverb2_f_effect_9,
	midiverb2_f_effect_10,
	midiverb2_f_effect_11,
	midiverb2_f_effect_12,
	midiverb2_f_effect_13,
	midiverb2_f_effect_14,
	midiverb2_f_effect_15,
	midiverb2_f_effect_16,
	midiverb2_f_effect_17,
	midiverb2_f_effect_18,
	midiverb2_f_effect_19,
	midiverb2_f_effect_20,
	midiverb2_f_effect_21,
	midiverb2_f_effect_22,
	midiverb2_f_effect_23,
	midiverb2_f_effect_24,
	midiverb2_f_effect_25,
	midiverb2_f_effect_26,
	midiverb2_f_effect_27,
	midiverb2_f_effect_28,
	midiverb2_f_effect_29,
	midiverb2_f_effect_30,
	midiverb2_f_effect_31,
	midiverb2_f_effect_32,
	midiverb2_f_effect_33,
	midiverb2_f_effect_34,
	midiverb2_f_effect_35,
	midiverb2_f_effect_36,
	midiverb2_f_effect_37,
	midiverb2_f_effect_38,
	midiverb2_f_effect_39,
	midiverb2_f_effect_40,
	midiverb2_f_effect_41,
	midiverb2_f_effect_42,
	midiverb2_f_effect_43,
	midiverb2_f_effect_44,
	midiverb2_f_effect_45,
	midiverb2_f_effect_46,
	midiverb2_f_effect_47,
	midiverb2_f_effect_48,
	midiverb2_f_effect_49,
	midiverb2_f_effect_50,
	midiverb2_f_effect_51,
	midiverb2_f_effect_52,
	midiverb2_f_effect_53,
	midiverb2_f_effect_54,
	midiverb2_f_effect_55,
	midiverb2_f_effect_56,
	midiverb2_f_effect_57,
	midiverb2_f_effect_58,
	midiverb2_f_effect_59,
	midiverb2_f_effect_60,
	midiverb2_f_effect_61,
	midiverb2_f_effect_62,
	midiverb2_f_effect_63,
	midiverb2_f_effect_64,
	midiverb2_f_effect_65,
	midiverb2_f_effect_66,
	midiverb2_f_effect_67,
	midiverb2_f_effect_68,
	midiverb2_f_effect_69,
	midiverb2_f_effect_70,
	midiverb2_f_effect_71,
	midiverb2_f_effect_72,
	midiverb2_f_effect_73,
	midiverb2_f_effect_74,
	midiverb2_f_effect_75,
	midiverb2_f_effect_76,
	midiverb2_f_effect_77,
	midiverb2_f_effect_78,
	midiverb2_f_effect_79,
	midiverb2_f_effect_80,
	midiverb2_f_effect_81,
	midiverb2_f_effect_82,
	midiverb2_f_effect_83,
	midiverb2_f_effect_84,
	midiverb2_f_effect_85,
	midiverb2_f_effect_86,
	midiverb2_f_effect_87,
	midiverb2_f_effect_88,
	midiverb2_f_effect_89,
	midiverb2_f_effect_90,
	midiverb2_f_effect_91,
	midiverb2_f_effect_92,
	midiverb2_f_effect_93,
	midiverb2_f_effect_94,
	midiverb2_f_effect_95,
	midiverb2_f_effect_96,
	midiverb2_f_effect_97,
	midiverb2_f_effect_98,
	midiverb2_f_effect_99,
};
