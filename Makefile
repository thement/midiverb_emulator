...
decompiled-midiverb.h: roms/midiverb.rom names-midiverb.h disasm.py
	python3 ./disasm.py roms/midiverb.rom -i -d $@ --prefix midiverb_ --names names-midiverb.h --unit-name Midiverb

decompiled-midifex.h: roms/midifex.rom names-midifex.h disasm.py
	python3 ./disasm.py roms/midifex.rom -i -d $@ --prefix midifex_ --names names-midifex.h --unit-name Midifex

decompiled-midiverb2.h: roms/midiverb2.rom names-midiverb2.h disasm.py
	python3 ./disasm.py -2 roms/midiverb2.rom -i -d $@ --prefix midiverb2_ --names names-midiverb2.h --unit-name "Midiverb 2"
