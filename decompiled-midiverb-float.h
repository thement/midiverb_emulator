...
void midiverb_f_effect_1(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	...
	Acc = LINE(12, 16321, 89) * 0.625 + LINE(13, 16381, 0) * 0.625 + LINE(13, 16381, 58);
	WRITE_LINE(12, 16321) = -Acc;
	Acc = LINE(11, 16230, 113) * 0.625 + LINE(12, 16321, 0) * 0.625 + LINE(12, 16321, 89);
	WRITE_LINE(11, 16230) = -Acc;
	Acc = -LINE(11, 16230, 0) / 4;
	tmp_1 = -Acc;
	Acc = -Acc / 2 + LINE(11, 16230, 0) / 2 + LINE(11, 16230, 113) + tmp_1 / 2;
	tmp_1 = -Acc;
	Acc = Acc * -1.6875 + tmp_1 * 3.375;
	tmp_b = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_2(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_1, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	...
	Acc = LINE(13, 16321, 89) * 0.625 + LINE(14, 16381, 0) * 0.625 + LINE(14, 16381, 58);
	WRITE_LINE(13, 16321) = -Acc;
	Acc = LINE(12, 16230, 113) * 0.625 + LINE(13, 16321, 0) * 0.625 + LINE(13, 16321, 89);
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_3(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_1, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	...
	Acc = LINE(12, 16321, 89) * 0.625 + LINE(13, 16381, 0) * 0.625 + LINE(13, 16381, 58);
	WRITE_LINE(12, 16321) = -Acc;
	Acc = LINE(11, 16230, 183) * 0.625 + LINE(12, 16321, 0) * 0.625 + LINE(12, 16321, 89);
	WRITE_LINE(11, 16230) = -Acc;
	Acc = -LINE(11, 16230, 0) / 4;
	tmp_1 = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_4(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_1, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	...
	Acc = LINE(12, 16321, 89) * 0.625 + LINE(13, 16381, 0) * 0.625 + LINE(13, 16381, 58);
	WRITE_LINE(12, 16321) = -Acc;
	Acc = LINE(11, 16230, 103) * 0.625 + LINE(12, 16321, 0) * 0.625 + LINE(12, 16321, 89);
	WRITE_LINE(11, 16230) = -Acc;
	Acc = -LINE(11, 16230, 0) / 4;
	tmp_1 = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_5(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_1, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	...
	Acc = LINE(13, 16321, 89) * 0.625 + LINE(14, 16381, 0) * 0.625 + LINE(14, 16381, 58);
	WRITE_LINE(13, 16321) = -Acc;
	Acc = LINE(12, 16230, 103) * 0.625 + LINE(13, 16321, 0) * 0.625 + LINE(13, 16321, 89);
	WRITE_LINE(12, 16230) = -Acc;
	Acc = -LINE(12, 16230, 0) / 4;
	tmp_1 = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_6(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_1, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(10, 15812, 64) / 2 + LINE(8, 14975, 396) / 2 + LINE(6, 13974, 339) / 2 + LINE(4, 13216, 179) / 2;
	tmp_1 = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_7(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_b, tmp_1, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	...
	Acc = LINE(13, 16321, 89) * 0.625 + LINE(14, 16381, 0) * 0.625 + LINE(14, 16381, 58);
	WRITE_LINE(13, 16321) = -Acc;
	Acc = LINE(12, 16230, 183) * 0.625 + LINE(13, 16321, 0) * 0.625 + LINE(13, 16321, 89);
	WRITE_LINE(12, 16230) = -Acc;
	Acc = -LINE(12, 16230, 0) / 4;
	tmp_1 = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_8(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_3, tmp_5, tmp_b;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_9(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_3, tmp_5, tmp_b;
	WRITE_LINE(0, 0) = input;
	...
	Acc = LINE(14, 16182, 198) * 0.625 + LINE(15, 16282, 0) * 0.625 + LINE(15, 16282, 98);
	WRITE_LINE(14, 16182) = -Acc;
	Acc = LINE(13, 15982, 367) * 0.625 + LINE(14, 16182, 0) * 0.625 + LINE(14, 16182, 198);
	WRITE_LINE(13, 15982) = -Acc;
	Acc = LINE(13, 15982, 0) * 0.625 + LINE(13, 15982, 367) + LINE(12, 15113, 789) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_10(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_3, tmp_5, tmp_b;
	WRITE_LINE(0, 0) = input;
	Acc = -LINE(11, 14322, 123) / 4 + -LINE(9, 11770, 987) / 4 + -LINE(5, 6614, 678) / 4 + -LINE(14, 16182, 142) / 4;
	tmp_5 = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_11(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_3, tmp_5, tmp_b;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_12(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_13(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_3, tmp_5, tmp_b;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_14(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_3, tmp_5, tmp_b;
	WRITE_LINE(0, 0) = input;
	...
	Acc = LINE(13, 15982, 367) * 0.625 + LINE(14, 16182, 0) * 0.625 + LINE(14, 16182, 198);
	WRITE_LINE(13, 15982) = -Acc;
	Acc = LINE(13, 15982, 0) * 0.625 + LINE(13, 15982, 367) + LINE(12, 15113, 875) / 2;
	WRITE_LINE(12, 15113) = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_15(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_3, tmp_5, tmp_b;
	WRITE_LINE(0, 0) = input;
	...
	Acc = LINE(13, 16182, 198) * 0.625 + LINE(14, 16282, 0) * 0.625 + LINE(14, 16282, 98);
	WRITE_LINE(13, 16182) = -Acc;
	Acc = LINE(12, 15982, 367) * 0.625 + LINE(13, 16182, 0) * 0.625 + LINE(13, 16182, 198);
	WRITE_LINE(12, 15982) = -Acc;
	Acc = LINE(12, 15982, 0) * 0.625 + LINE(12, 15982, 367) + LINE(11, 15113, 1256) / 2;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_16(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_3, tmp_5, tmp_b;
	WRITE_LINE(0, 0) = input;
	...
	Acc = LINE(15, 16282, 98) * 0.625 + LINE(3, 1944, 0) / 2;
	WRITE_LINE(15, 16282) = -Acc;
	Acc = LINE(14, 16182, 198) * 0.625 + LINE(15, 16282, 0) * 0.625 + LINE(15, 16282, 98);
	WRITE_LINE(14, 16182) = -Acc;
	Acc = LINE(13, 15982, 367) * 0.625 + LINE(14, 16182, 0) * 0.625 + LINE(14, 16182, 198);
	WRITE_LINE(13, 15982) = -Acc;
	Acc = LINE(13, 15982, 0) * 0.625 + LINE(13, 15982, 367) + LINE(12, 15113, 987) / 2;
	WRITE_LINE(12, 15113) = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_17(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_3, tmp_5, tmp_b;
	WRITE_LINE(0, 0) = input;
	...
	WRITE_LINE(14, 16282) = -Acc;
	Acc = LINE(13, 16202, 147) * 0.625 + LINE(14, 16282, 0) * 0.625 + LINE(14, 16282, 78);
	WRITE_LINE(13, 16202) = -Acc;
	Acc = LINE(12, 16053, 367) * 0.625 + LINE(13, 16202, 0) * 0.625 + LINE(13, 16202, 147);
	WRITE_LINE(12, 16053) = -Acc;
	Acc = LINE(12, 16053, 0) * 2.109375 + LINE(12, 16053, 367) * 3.375;
	tmp_b = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_18(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_3, tmp_5, tmp_b;
	WRITE_LINE(0, 0) = input;
	...
	Acc = LINE(12, 16202, 147) * 0.625 + LINE(13, 16282, 0) * 0.625 + LINE(13, 16282, 78);
	WRITE_LINE(12, 16202) = -Acc;
	Acc = LINE(11, 16053, 367) * 0.625 + LINE(12, 16202, 0) * 0.625 + LINE(12, 16202, 147);
	WRITE_LINE(11, 16053) = -Acc;
	Acc = LINE(11, 16053, 0) * 2.109375 + LINE(11, 16053, 367) * 3.375;
	tmp_b = Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_19(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_20(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_21(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_22(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_23(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_24(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_25(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_26(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_27(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_28(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_29(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_30(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_31(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_32(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_33(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = -LINE(8, 13241, 21) / 4 + -LINE(6, 9821, 1591) / 4 + -LINE(4, 5436, 2003) / 4;
	tmp_3 = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_34(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_35(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_36(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_37(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = -LINE(8, 12641, 21) / 4 + -LINE(6, 9021, 1891) / 4 + -LINE(4, 4536, 2003) / 4;
	tmp_3 = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_38(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_39(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = -LINE(7, 12641, 21) / 4 + -LINE(5, 9021, 1891) / 4 + -LINE(3, 4536, 2003) / 4;
	tmp_3 = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_40(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_41(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = -LINE(8, 12641, 21) / 4 + -LINE(6, 9021, 1891) / 4 + -LINE(4, 4536, 2003) / 4;
	tmp_3 = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_42(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = -LINE(7, 12641, 21) / 4 + -LINE(5, 9021, 1891) / 4 + -LINE(3, 4536, 2003) / 4;
	tmp_3 = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_43(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_44(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_45(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = -LINE(8, 12641, 21) / 4 + -LINE(6, 9021, 1891) / 4 + -LINE(4, 4536, 2003) / 4;
	tmp_3 = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_46(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = -LINE(7, 12641, 21) / 4 + -LINE(5, 9021, 1891) / 4 + -LINE(3, 4536, 2003) / 4;
	tmp_3 = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_47(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_48(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_49(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_1, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_50(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_2, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_51(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_5;
	WRITE_LINE(0, 0) = input;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_52(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(2, 11, 2) / 2 + LINE(8, 2298, 21) / 2;
	WRITE_LINE(8, 2298) = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_53(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(2, 11, 2) / 2 + LINE(8, 2298, 21) / 2;
	WRITE_LINE(8, 2298) = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_54(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(2, 11, 2) / 2 + LINE(8, 2298, 21) / 2;
	WRITE_LINE(8, 2298) = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_55(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(2, 11, 2) / 2 + LINE(8, 2298, 21) / 2;
	WRITE_LINE(8, 2298) = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_56(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(2, 11, 2) / 2 + LINE(8, 2298, 21) / 2;
	WRITE_LINE(8, 2298) = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_57(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(2, 11, 2) / 2 + LINE(8, 2298, 21) / 2;
	WRITE_LINE(8, 2298) = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_58(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(2, 11, 2) / 2 + LINE(8, 2298, 21) / 2;
	WRITE_LINE(8, 2298) = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_59(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(2, 11, 2) / 2 + LINE(8, 2298, 21) / 2;
	WRITE_LINE(8, 2298) = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_60(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_61(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(1, 11, 2) / 2 + LINE(7, 2298, 21) / 2;
	WRITE_LINE(7, 2298) = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_62(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(1, 11, 2) / 2 + LINE(7, 2298, 21) / 2;
	WRITE_LINE(7, 2298) = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_63(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc, tmp_3, tmp_5;
	WRITE_LINE(0, 0) = input;
	Acc = LINE(1, 11, 2) / 2 + LINE(7, 2298, 21) / 2;
	WRITE_LINE(7, 2298) = -Acc;
...
#define LINE(id,w_addr,r_offset) (DRAM[(ptr + w_addr - r_offset) & 0x3fff])
#define WRITE_LINE(id,w_addr) (DRAM[(ptr + w_addr) & 0x3fff])
void midiverb_f_effect_64(float input, float *out_left, float *out_right, float DRAM[0x4000], int ptr) {
	float Acc;
...
#undef LINE
#undef WRITE_LINE
void (*midiverb_f_effects[])(float input, float *out_left, float *out_right, float *DRAM, int ptr) = {
	midiverb_f_effect_1,
	midiverb_f_effect_2,
	midiverb_f_effect_3,
	midiverb_f_effect_4,
	...
	midiverb_f_effect_8,
	midiverb_f_effect_9,
	midiverb_f_effect_10,
	midiverb_f_effect_11,
	midiverb_f_effect_12,
	midiverb_f_effect_13,
	midiverb_f_effect_14,
	midiverb_f_effect_15,
	midiverb_f_effect_16,
	midiverb_f_effect_17,
	midiverb_f_effect_18,
	midiverb_f_effect_19,
	midiverb_f_effect_20,
	midiverb_f_effect_21,
	midiverb_f_effect_22,
	midiverb_f_effect_23,
	midiverb_f_effect_24,
	midiverb_f_effect_25,
	midiverb_f_effect_26,
	midiverb_f_effect_27,
	midiverb_f_effect_28,
	midiverb_f_effect_29,
	midiverb_f_effect_30,
	midiverb_f_effect_31,
	midiverb_f_effect_32,
	midiverb_f_effect_33,
	midiverb_f_effect_34,
	midiverb_f_effect_35,
	midiverb_f_effect_36,
	midiverb_f_effect_37,
	midiverb_f_effect_38,
	midiverb_f_effect_39,
	midiverb_f_effect_40,
	midiverb_f_effect_41,
	midiverb_f_effect_42,
	midiverb_f_effect_43,
	midiverb_f_effect_44,
	midiverb_f_effect_45,
	midiverb_f_effect_46,
	midiverb_f_effect_47,
	midiverb_f_effect_48,
	midiverb_f_effect_49,
	midiverb_f_effect_50,
	midiverb_f_effect_51,
	midiverb_f_effect_52,
	midiverb_f_effect_53,
	midiverb_f_effect_54,
	midiverb_f_effect_55,
	midiverb_f_effect_56,
	midiverb_f_effect_57,
	midiverb_f_effect_58,
	midiverb_f_effect_59,
	midiverb_f_effect_60,
	midiverb_f_effect_61,
	midiverb_f_effect_62,
	midiverb_f_effect_63,
	midiverb_f_effect_64,
};
